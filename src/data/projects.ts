...
export const projects: Project[] = [
  ...
  //   challenge:
  //     "Implementing a secure payment system while ensuring a smooth user experience across devices.",
  //   solution:
  //     "Leveraged Stripe API with custom hooks for payment processing and developed responsive interfaces with TailwindCSS.",
  // },
  {
    id: 2,
    ...
    challenge:
      "Creating a real-time collaboration system that maintains data integrity with multiple concurrent users.",
    solution:
      "Implemented SignalR for real-time updates and designed a robust API with optimistic concurrency control.",
  },
  {
    id: 3,
    title: "Healthcare Management System",
    description:
      "A secure healthcare Management System allowing patients to schedule appointments and access medical records.",
    image:
    ...
    technologies: [".NET Core MVC", "SQL", "Bootstrap"],
    challenge:
      "Ensuring HIPAA compliance while providing a user-friendly interface for medical record access.",
    solution:
      "Implemented role-based access control, audit logging, and end-to-end encryption for sensitive data.",
  },
  {
    id: 4,
