  ...
  const contactInfo = [
    {
      icon: Mail,
      label: "Email",
      value: "rizverahman.ai@gmail.com",
      href: "mailto:rizverahman.ai@gmail.com",
      ...
      <div className="container-custom">
        ...
        <div className="text-center mb-16">
          ...
          >
            ...
            discuss new opportunities, collaborate on innovative ideas, or
            simply connect with fellow developers and entrepreneurs.
          </motion.p>
        </div>
          ...
          >
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              {contactInfo.map((info, index) => (
                ...
                >
                  <div
                    className={`inline-flex items-center justify-center w-12 h-12 rounded-xl bg-gradient-to-r ${info.color} text-white mb-4 group-hover:scale-110 transition-transform duration-300`}
                  >
                    <info.icon size={20} />
                  </div>
            ...
            >
              ...
              <p className="text-text-light mb-6 leading-relaxed">
                Follow my journey, see my latest projects, and connect with me
                on social media. I love sharing insights about development and
            ...
            >
              ...
              <p className="text-text-light text-sm leading-relaxed">
                ...
                matters, feel free to reach out via phone or LinkedIn for faster
                communication.
              </p>
            </motion.div>
          </motion.div>
          ...
          >
            ...
            <div className="bg-background border border-background-alt rounded-2xl overflow-hidden shadow-lg">
              ...
              <div className="aspect-video relative">
                <iframe
                  src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d116833.97303546032!2d90.33728772247625!3d23.780818635270865!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3755b8b087026b81%3A0x8fa563bbdd5904c2!2sDhaka!5e0!3m2!1sen!2sbd!4v1757866152443!5m2!1sen!2sbd"
                  width="100%"
                  height="100%"
                  style={{ border: 0 }}
                  allowFullScreen
